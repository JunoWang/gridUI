...
schematic = (function() {
	...
	function Schematic(input) {
		...
		if (analyses.indexOf('ac') != -1) {
		    ...
		    this.ac_npts = '20'; // default values for AC Analysis
		    this.ac_fstart = '10';
		    this.ac_fstop = '1G';
	...
	// here to redraw background images containing static portions of the schematic.
	...
	// redraw what user sees = static images + dynamic parts
	Schematic.prototype.redraw = function() {
	    var c = this.canvas.getContext('2d');

	    // put static images in the background
	...
	Schematic.prototype.graph = function(x_values,x_legend,y_values,y_legend,z_values,z_legend) {
	    ...
	    // the graph itself will be drawn here and this images will be copied
		...
		for (var z = z_min; z <= z_max; z += z_limits[2]) {
		    ...
		    // tick mark
		    c.beginPath();
		    c.moveTo(left_margin + pwidth,temp);
		    c.lineTo(left_margin + pwidth + tick_length,temp);
		    c.stroke();
